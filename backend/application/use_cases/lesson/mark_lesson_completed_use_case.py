"""
Caso de uso: Marcar lección como completada - FagSol Escuela Virtual
"""
...
class MarkLessonCompletedUseCase:
    """
    Caso de uso: Marcar lección como completada
    ...
    def execute(
        ...
        """
        Ejecuta el caso de uso de marcar lección como completada
        ...
        try:
            ...
            logger.error(f"Error al marcar lección como completada: {str(e)}", exc_info=True)
            return UseCaseResult(
                success=False,
                error_message=f"Error al marcar lección como completada: {str(e)}"
            )
