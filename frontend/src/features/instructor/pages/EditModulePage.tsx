...
function EditModulePageContent() {
        ...
        <div className="min-h-screen bg-primary-black text-primary-white relative overflow-hidden">
                    ...
                    <div className="flex justify-between items-center py-6">
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p className="text-secondary-light-gray font-medium mt-1">Modifica la información del módulo</p>
                            </div>
                        </div>
            ...
            <main className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="bg-secondary-dark-gray/60 border border-primary-orange/20 rounded-xl shadow-lg p-8 backdrop-blur-sm">
                    <ModuleForm courseId={courseId} moduleId={moduleId} onSuccess={handleSuccess} />
                </div>
            </main>
        </div>
    );
