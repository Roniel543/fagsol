    ...
    if (loadingModule) {
        return (
            <div className="flex items-center justify-center py-12">
                ...
                <p className="ml-4 text-gray-700 font-medium">Cargando módulo...</p>
            </div>
        );
    }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={handleChange}
                        className={`w-full px-4 py-3 border ${errors.price ? 'border-red-300' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-orange focus:border-primary-orange text-gray-900 bg-white placeholder-gray-400 transition-all duration-300`}
                    />
                    {errors.price && (
