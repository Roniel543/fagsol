...
import { CoursePlaceholder, Footer, MultiCurrencyPrice, useToast } from '@/shared/components';
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                        <div>
                            <h1 className="text-2xl sm:text-3xl font-bold flex items-center gap-3">
                                <ShoppingCart className="w-6 h-6 sm:w-8 sm:h-8 text-primary-orange" />
                                Mi Carrito
                            </h1>
                        ...
                        <Link
                            ...
                            className="flex items-center gap-2 text-primary-orange hover:underline text-sm sm:text-base"
                        >
                    ...
                    {cartItemsWithDetails.length === 0 ? (
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                    ...
                                    >
                                        <div className="flex flex-col sm:flex-row gap-4">
                                            ...
                                            <Link
                                                ...
                                                className="relative w-full sm:w-32 h-40 sm:h-24 rounded-lg overflow-hidden bg-zinc-800 flex-shrink-0"
                                            >
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 sm:gap-4">
                                                    <div className="flex-1 min-w-0">
                                                        <Link
                                                            href={`/academy/course/${item.course.slug}`}
                                                            className="font-semibold text-primary-white hover:text-primary-orange transition-colors block break-words"
                                                        >
                                                            {item.course.title}
                                                        </Link>
                            ...
                            <div className="lg:col-span-1">
                                <div className="rounded-xl border border-zinc-800 bg-zinc-900/60 p-4 sm:p-6 lg:sticky lg:top-6">
